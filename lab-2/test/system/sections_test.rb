...
class SectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Section" do
    ...
    fill_in "Belongs to", with: @section.belongs_to
    fill_in "Buildingandroom", with: @section.buildingAndRoom
    fill_in "Instructor", with: @section.instructor
    fill_in "Instructoremail", with: @section.instructorEmail
    fill_in "Numgradersneeded", with: @section.numGradersNeeded
